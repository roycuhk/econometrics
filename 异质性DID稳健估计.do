...
event_plot, default_look graph_opt(xtitle("Periods since the event") ytitle("Average causal effect") title("Borusyak et al(2
 021) imputaion estimator") xlabel(-5(1)5) name(BJS, replace)) together
...
event_plot e(b)#e(V), default_look graph_opt(xtitle("Periods since the event") ytitle("Average causal effect")///
 xlabel(-14(1)5) title("Callaway and Sant'Anna (2020)") name(CS, replace)) stub_lag(Tm#) stub_lead(Tp#) together
